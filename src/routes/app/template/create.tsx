...
import type { TRitualTemplateRequest, TItemTemplate } from "@/schemas/Template"
...
function RouteComponent() {
  ...
  const [items, setItems] = useState<TItemTemplate[]>([])
  ...
  const onAddItem = (values: z.infer<typeof itemSchema>) => {
    setItems(prev => [...prev, {
      ...values,
